...
#include "UnrealBroomInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UUnrealBroomInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UUnrealBroomInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UUnrealBroomInteractiveTool* NewTool = NewObject<UUnrealBroomInteractiveTool>(SceneState.ToolManager);
...
UUnrealBroomInteractiveToolProperties::UUnrealBroomInteractiveToolProperties()
{
...
void UUnrealBroomInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UUnrealBroomInteractiveTool::Setup()
{
	...
	Properties = NewObject<UUnrealBroomInteractiveToolProperties>(this, "Measurement");
...
void UUnrealBroomInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UUnrealBroomInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UUnrealBroomInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UUnrealBroomInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UUnrealBroomInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UUnrealBroomInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UUnrealBroomInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UUnrealBroomInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UUnrealBroomInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
